        ...
        copy: {
            fire: {
              files: [
                ...
                {expand: true, cwd: './nodes/camera-command/', src: ['**'], dest: './packages/fire/nodes/camera-command/'},
                {expand: true, cwd: './nodes/camera/', src: ['**'], dest: './packages/fire/nodes/camera/'},
                {expand: true, cwd: './nodes/mlkit/', src: ['**'], dest: './packages/fire/nodes/mlkit/'},
                {expand: true, cwd: './nodes/qrcode/', src: ['**'], dest: './packages/fire/nodes/qrcode/'},
                {expand: true, cwd: './examples/', src: ['sqlite.json','ble.json','camera-command.json','mlkit.json','qrcode.json','startActivity.json'], dest: './packages/fire/examples/'},
